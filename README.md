...
| **Dashboard Overview** | **Agency Management** |
|:---:|:---:|
| ![Dashboard](screenshots/dashboard.png) | ![Agencies](screenshots/agencies.png) |
| *Real-time statistics and usage tracking* | *Browse and filter agency directory* |

| **Contact Browser** | **Premium Upgrade** |
|:---:|:---:|
| ![Contacts](screenshots/contacts.png) | ![Upgrade Modal](screenshots/upgrade.png) |
| *View contacts with masked details* | *Premium upsell when daily limit is reached* |
